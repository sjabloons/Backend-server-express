  ...
  <body>
    <div class="container">
      ...
      <ul>
        ...
        <li><strong>Haarkleur:</strong> <div style="background-color: ${data.haarkleur}; width: 20px; height: 20px; border-radius: 50%; display: inline-block;">${data.haarkleur}</div> </li>
